...
//////////////////////////////////////		
        ...
        $.ajax({
            ...
            type: 'POST',
            url: "http://localhost:8080/api/admin/vocab/save",
    ...
    $('#updateVocab').click(function () {
        ...
        $.ajax({
            data: formData,
            type: 'POST',
            url: "http://localhost:8080/api/admin/vocab/update",
            enctype: 'multipart/form-data',
            contentType: false,
            cache: false,
            processData: false,
    ...
    $(document).on('click', '.editBaiVocab', function (e) {
        ...
        $.ajax({
            type: 'GET',
            url: "http://localhost:8080/api/admin/vocab/infoVocab/" + idBaiVocab,
            success: function (data) {
    ...
    $(document).on('click', '.deleteBaiVocab', function () {
        ...
        if (confirm("Bạn muốn xóa bài từ vựng này?")) {
            $.ajax({
                type: 'POST',
                url: "http://localhost:8080/api/admin/vocab/delete/" + idBaiVocab,
    ...
    function loadAllVocab() {
        ...
        $.ajax({
            dataType: 'json',
            type: 'GET',
            url: "http://localhost:8080/api/admin/vocab/loadVocab",
