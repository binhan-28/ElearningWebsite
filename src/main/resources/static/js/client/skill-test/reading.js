				...
				if (result.error == false) {
					...
					$.each(result.object.content, function(i, baiDoc) {
						...
						html += '<div class="job-box d-md-flex align-items-center justify-content-between mb-30">'
							...
							+ '	<li class="mr-md-4">'
							+ '		<i class="zmdi zmdi-pin mr-2"></i>Part ' + baiDoc.part
							+ '	</li>'
							+ '<li class="mr-md-4">'
							...
							+ '<a class="btn d-block w-100 d-sm-inline-block btn-light" href="/test/skill-test/reading/part-'+baiDoc.part+'/'+baiDoc.id+'">Làm ngay</a>'
							+ '</div>'
							+ '</div>'
