...
public class GrammarQuestion {
	...
	@ManyToOne
	@JoinColumn(name = "grammarExerciseId")
	private GrammarExercise grammarExercise;
	...
	public GrammarExercise getGrammarExercise() {
		return grammarExercise;
	}

	public void setGrammarExercise(GrammarExercise grammarExercise) {
		this.grammarExercise = grammarExercise;
	}
